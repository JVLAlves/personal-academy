...
class Ui_PatientSearch(object):
    def setupUi(self, PatientSearch):
        ...
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(180, 130, 61, 31))
        self.label.setObjectName("label")
        ...
        self.PatTableWidget.setColumnCount(3)
        self.PatTableWidget.setColumnWidth(0, 150)
        self.PatTableWidget.setColumnWidth(1, 250)
        self.PatTableWidget.setColumnWidth(2, 200)
    ...
    def retranslateUiforSearchPatient(self, PatientSearch):
        ...
        item.setText(_translate("PatientSearch", "PAGAMENTO"))
    ...
    def LoadData(self):
        ...
        for Patient in Patients:
            self.PatTableWidget.setItem(row, 0, QtWidgets.QTableWidgetItem(str(Patient["Name"])))
            self.PatTableWidget.setItem(row, 1, QtWidgets.QTableWidgetItem(str(Patient["PayPerSession"])))
            row+=1
...
class Ui_NewPatientWindow(object):
    ...
    def AddPatient(self):
        ...
        InsertPatient(Patname, value, wb)
        msg = QMessageBox()
        msg.setIcon(msg.Information)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(180, 20, 261, 51))
        self.label.setObjectName("label")
